...
import {
  acceptCustomServiceQuote,
  createCustomServiceRequest,
  declineCustomServiceQuote,
} from "./actions";
    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <section className="mx-auto max-w-5xl px-6 py-10">
        ...
        {saved === "accepted" && (
          <div className="mb-6 rounded-2xl border border-green-200 bg-green-50 px-5 py-4">
            <p className="font-medium text-green-800">
              Quote accepted successfully. Duck Home
              Services will schedule your job next.
            </p>
          </div>
        )}
        ...
        {saved === "declined" && (
          <div className="mb-6 rounded-2xl border border-stone-300 bg-white px-5 py-4">
            <p className="font-medium text-stone-800">
              Quote declined. The request has been
              cancelled.
            </p>
          </div>
        )}
              ...
              >
                ...
                <div className="rounded-xl bg-stone-50 p-4">
                  <p className="text-sm leading-6 text-stone-600">
                    ...
                    is needed, you&apos;ll be able to
                    review and accept the quote before
                      ...
                      {request.status ===
                        ...
                        <div className="mt-4 space-y-2">
                          ...
                          >
                            ...
                            <button
                              type="submit"
                              className="w-full rounded-xl border border-stone-300 bg-white px-4 py-2.5 text-sm font-medium text-stone-700 transition hover:bg-stone-100"
                            >
                              Decline Quote
                            </button>
                          </form>
                      ...
                      {request.status ===
                        ...
                        <div className="mt-4 rounded-lg border border-green-200 bg-green-50 px-3 py-3">
                          ...
                          <p className="mt-1 text-xs leading-5 text-green-700">
                            Waiting for Duck Home Services
